...
public class QuickAxe extends QuickTool {
	...
	protected Supplier<Item> getItemSupplier() {
		return () ->
		new IItem.Adapter.Builder<AxeItem>(AxeItem.class)
				.constructor(IItemTier.class, float.class, float.class, Item.Properties.class)
				.args(QuickTieredItem.getTier(this.getTier()), this.getAttack(), this.getSpeed(), IItem.Adapter.getProperties(this))
				.build(this).MODEL;
	}
